                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.featureRow}>
                        ...
                        <View style={styles.featureItemContainer}>
                            <TouchableOpacity style={[styles.iconCircle, { backgroundColor: '#FF7F27' }]}>
                                <MaterialCommunityIcons name="email-outline" size={30} color="#fff" />
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity style={styles.chatCard}>
                        ...
                        <View style={styles.chatContent}>
                            ...
                            <View style={styles.chatHeaderRow}>
                                <Text style={styles.chatMessage} numberOfLines={1}>Kamu punya pesan</Text>
